...
const PublisherDetailsModal: React.FC<PublisherDetailsModalProps> = ({ isOpen, onClose, publisher }) => {
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-2">
                    ...
                    <span className="flex items-center gap-1 px-2.5 py-1 rounded-md border border-amber-500/20 text-[9px] font-bold text-amber-500 uppercase tracking-widest bg-amber-500/10">
                      ...
                      {publisher.average_rating > 0 ? publisher.average_rating : 'Novo'} 
                      ({publisher.reviews_count || 0})
                    </span>
                  </div>
                </div>
              </div>
